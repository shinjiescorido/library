...
//$_book->getCategoryName();
 ...
 <form method="post" action="">
	...
	<?php } ?>
 	...
 	<div id='add_book' class='modal fade in' style='text-align:left'>
          <!-- <pre class="pre-scrollable">-->
            ...
            <div class='modal-body'>
			 ...
			 <h2 class="form-signin-heading">Book Information</h2>
 ...
 <table cellpadding="5" cellspacing="5" style="" class="table table-hover table-condensed">
	<tr style="background:grey" class="table-hover">
		...
		<td style="text-transform:uppercase">Book Borrowers</td>
...
echo "<tr style='background:#fff'>";
	...
	echo "<td><a data-toggle='modal' href='#edit_{$row->Book_Id}'><button>Edit</button></a>&nbsp;|&nbsp;<a onclick='delBook(\"{$row->Book_Id}\");'><button>Delete</button></a>";
	...
	echo "<td>".$row->Book_Borrowers." <button>View</button></td>";
	echo "</td>";
echo "</tr>";
        }
		}else{
 ...
 <script>
	function delBook(id){
		if(confirm("Delete This Book on the database?")){
			jQuery.post(
