...
<div class = "userTable">
<table cellpadding="0" cellspacing="0" border="0" class="borrowedbooks" style="width:100%">
	<thead>
	...
	<tbody>
		<?php 
		$ars = $book_obj->getAllReservedBooks();
...
<td>
	<a href="#" id="<?php echo $useritem->Book_Id; ?>" class="btn btn-danger reserve-button">Cancel Reservation
	</a>
</td>
